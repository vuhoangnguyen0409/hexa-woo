...
?>
  ...
  <div class="inside-header">
   <div class="container"><?php the_title(); ?>
   </div>
   </div>
  <div class="content">
    <div class="container">
      ...
      <div class="services">
        ...
        <ul class="row">
				<?php
				if( have_rows('our-service') ):// repeater
					// loop through the rows of data
						while ( have_rows('our-service') ) : the_row();
								// display a sub field value
									$our_services = get_sub_field( 'our-service-item' );//group
									if ( $our_services )://group?>
									<li class="col-sm-4">
										<div class="sec"> <i class="<?php echo $our_services['ser-fa']; ?>" aria-hidden="true"></i>
											<h6><?php echo $our_services['ser-title']; ?></h6>
											<!--======= HOVER SECTION =========-->
											<div class="ser-over">
												<h6><?php echo $our_services['ser-title']; ?></h6>
												<p><?php echo $our_services['ser-description']; ?></p>
